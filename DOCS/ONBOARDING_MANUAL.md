...
### 3.4. Manufactura y Cadena de Suministro

Para detalles específicos sobre los módulos operativos, consultar:

- **Manufactura (Producción)**: [Manual Técnico de Manufactura](./MANUAL_TECNICO_MANUFACTURA.md).
- **Logística, POS y Compras**: [Manual Técnico de Supply Chain](./MANUAL_TECNICO_SUPPLY_CHAIN.md).
